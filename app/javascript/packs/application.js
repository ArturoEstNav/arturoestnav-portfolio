...
const setCarousel = (projectList) => {
  ...
  let track = document.querySelector(`#${projectList} .custom-carousel-track`);
  let slides = Array.from(track.children[0].children);
  let prevButton = document.querySelector(`#${projectList} .custom-carousel-header .custom-controls`).children[0];
  let nextButton = document.querySelector(`#${projectList} .custom-carousel-header .custom-controls`).children[1];
